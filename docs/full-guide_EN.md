...
> If Discord / GitHub Actions scheduled pushes are still Chinese, confirm `REPORT_LANGUAGE=ko` is set under repository `Settings -> Secrets and variables -> Actions -> Variables`; an empty value falls back to Chinese.
