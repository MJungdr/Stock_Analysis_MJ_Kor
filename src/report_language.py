...
_CHIP_HEALTH_TRANSLATIONS = {
    "healthy": {"zh": "健康", "en": "Healthy", "ko": "건전"},
...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    ...
    "ko": {
        ...
        "action_window_label": "대응 구간",
        "immediate_action_label": "현재 대응",
