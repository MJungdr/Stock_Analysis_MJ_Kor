...
class Config:
    ...
    market_review_enabled: bool = False       # 是否启用大盘复盘（显式 opt-in）
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            # A market review is a separate, potentially expensive LLM workflow.  Keep
            # watchlist-only runs scoped to STOCK_LIST unless the user opts in.
